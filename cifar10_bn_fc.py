...
if __name__ == "__main__":
    ...
    if args.restore != 0.0:
        ...
        if args.restore == 1:
            ...
            model.module_list[0].fc.weight.data /= spec_0
            model.module_list[0].bn.weight.data /= lv_0
            model.module_list[1].fc.weight.data /= spec_1
            model.module_list[1].bn.weight.data /= lv_0 * lv_1
            model.fc.weight.data /= spec_2
            if args.prune != 0:
                model.module_list[0].fc.weight_orig.data /= spec_0
                model.module_list[1].fc.weight_orig.data /= spec_1
                model.fc.weight_orig.data /= spec_2
