...
do
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 0 -a synflow -p $i -s $1
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 4 -a synflow -p $i -s $1
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 0 -a snip -p $i -s $1
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 4 -a snip -p $i -s $1
