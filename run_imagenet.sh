...
do
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 1 -a uniform -p $i -s $1 -w 8
    # python imagenet.py -m resnet50 -i kaiming_in -r 2 -a uniform -p $i -s $1
    python imagenet.py -m resnet50 -i kaiming_in -r 3 -a uniform -p $i -s $1 -w 8
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 1.0 --beta 0.1 -a uniform -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 1.0 --beta 0.1 -a uniform -p $i -s $1
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.7 --beta 0.3 -a uniform -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.7 --beta 0.3 -a uniform -p $i -s $1
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.5 --beta 0.5 -a uniform -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.5 --beta 0.5 -a uniform -p $i -s $1
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 1 -a synflow -p $i -s $1
    # python imagenet.py -m resnet50 -i kaiming_in -r 2 -a synflow -p $i -s $1
    python imagenet.py -m resnet50 -i kaiming_in -r 3 -a synflow -p $i -s $1
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 1.0 --beta 0.1 -a synflow -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 1.0 --beta 0.1 -a synflow -p $i -s $1
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.7 --beta 0.3 -a synflow -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.7 --beta 0.3 -a synflow -p $i -s $1
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.5 --beta 0.5 -a synflow -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.5 --beta 0.5 -a synflow -p $i -s $1
    ...
    python imagenet.py -m resnet50 -i kaiming_in -r 1 -a snip -p $i -s $1 -w 8
    # python imagenet.py -m resnet50 -i kaiming_in -r 2 -a snip -p $i -s $1
    python imagenet.py -m resnet50 -i kaiming_in -r 3 -a snip -p $i -s $1 -w 8
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 1.0 --beta 0.1 -a snip -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 1.0 --beta 0.1 -a snip -p $i -s $1 -w 8
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.7 --beta 0.3 -a snip -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.7 --beta 0.3 -a snip -p $i -s $1 -w 8
    # python imagenet.py -m resnet50_res -i kaiming_in -r 0 --alpha 0.5 --beta 0.5 -a snip -p $i -s $1
    python imagenet.py -m resnet50_res -i kaiming_in -r 3 --alpha 0.5 --beta 0.5 -a snip -p $i -s $1 -w 8
done