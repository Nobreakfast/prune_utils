...
class ResNet(nn.Module):
    def __init__(
        ...
        self.layer1[0].conv1.weight.data.mul_(2**0.5)
        ...
        #                      nonlinearity="relu")
        # self.fc.weight.data.mul_(0.5 ** 0.5)
    ...
    def _make_layer(
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            ...
            # init.kaiming_normal_(downsample[0].weight, mode='fan_out',
            #                      nonlinearity='relu')
            # downsample[0].weight.data.mul_(0.5 ** 0.5)
        ...
        # if stride != 1 or self.inplanes != planes * block.expansion:
        #     layers[1].conv1.weight.data.mul_(0.5**0.5)
