...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option="A", alpha=None, beta=None):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, alpha=None, beta=None):
        ...
        self.layer1 = self._make_layer(
            block, 16, num_blocks[0], stride=1, alpha=alpha, beta=beta
        )
        self.layer2 = self._make_layer(
            block, 32, num_blocks[1], stride=2, alpha=alpha, beta=beta
        )
        self.layer3 = self._make_layer(
            block, 64, num_blocks[2], stride=2, alpha=alpha, beta=beta
        )
        self.fc = nn.Linear(64, num_classes)

        self.apply(_weights_init)

    def _make_layer(self, block, planes, num_blocks, stride, alpha, beta):
...
def resnet44(alpha, beta):
    return ResNet(BasicBlock, [7, 7, 7], alpha, beta)


def resnet56(alpha, beta):
    return ResNet(BasicBlock, [9, 9, 9], alpha, beta)


def resnet110(alpha, beta):
    return ResNet(BasicBlock, [18, 18, 18], alpha, beta)


def resnet1202(alpha, beta):
    return ResNet(BasicBlock, [200, 200, 200], alpha, beta)
